  ...
  const menuItems = [
    ...
    { href: "/about", label: "About Us" },
    {
      ...
      submenu: [
        ...
        { href: "/services/Delivery and Shipment", label: "Delivery and Shipment" },
        { href: "/services/Knitting", label: "Knitting" },
        { href: "/services/Embroidery", label: "Embroidery" },
        { href: "/services/Garment Dyeing & Wash", label: "Garment Dyeing & Wash" },
        { href: "/services/Printing", label: "Printing" },
        { href: "/services/Trimming & Accessories", label: "Trimming & Accessories" },
      ],
    },
