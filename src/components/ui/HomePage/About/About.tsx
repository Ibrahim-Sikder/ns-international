    ...
    <div className=" w-[1200px] mx-auto  flex space-x-20 mb-10">
      ...
      <div className="w-[500px] p-6 -mt-20 z-50 bg-white">
        <div className="flex-1 py-10">
          <h4 className=" text-blue-800 mb-2">Who We Are</h4>
      ...
      <div className="w-[400px] mt-16 ">
        <h4 className=" text-blue-800 mb-2">NS International</h4>
        ...
        <div className="grid grid-cols-3 gap-4">
            {/* Card 1 */}
            <div className="bg-gray-100 p-2 border border-gray-300 text-center py-10">
