    ...
    <Container className="my-20">
      ...
      {sections.map((section, index) => (
        ...
        >
          {index % 2 === 0 ? (
            <>
              <Image src={section.image} alt="Image" className="w-full border" />
