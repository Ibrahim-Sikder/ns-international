...
import faq from "../../../../public/assets/faq/faq.png";
  ...
  return (
    <>
      ...
      <Container className="my-20">
        ...
        <div className="lg:w-28 mx-auto h-1 bg-[#02ADFF] rounded-full mt-2 mb-7" />
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <p>
                  ...
                  purchase price of the home as a down payment, though some
                  loans may allow lower down payments (such as 5%-10%) depending
                  on credit scores and loan types.
                </p>
              </AccordionDetails>
            </Accordion>
              ...
              <AccordionDetails>
                <div className="space-y-5">
                  <p>
                    ...
                    real estate transaction, such as loan origination fees,
                    title insurance, attorney fees, and property taxes. These
                    usually amount to 2%-5% of the purchase price.
                  </p>
                </div>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <p className="text-justify">
                  ...
                  It&aos;s essential to choose a location that fits your
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <p className="text-justify">
                  ...
                  energy-efficient appliances, and enhancing landscaping are
                  great ways to boost your home’s value. Regular maintenance and
                  repairs also ensure your home stays market-ready.
                </p>
              </AccordionDetails>
            </Accordion>
          </div>
