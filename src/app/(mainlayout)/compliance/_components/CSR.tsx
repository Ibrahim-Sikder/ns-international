        ...
        <div className="bg-gray-100 lg:p-10 p-5">
          <div>
            ...
            <p className="text-justify mt-5">
              NS International prefers and works only with factories who take
              their social responsibility seriously and puts in effective
              measures to ensure the betterment of the community and environment
              around them. This not only boosts our morality but also gives our
              clients the opportunity to feel that something of greater good
              comes out of their business with us above the monetary
              transactions.
            </p>
            <p className="text-justify mt-5">
            ...
            <p className="text-justify mt-5">
              ...
              charitable initiatives across Bangladesh. And NS International
              Bangladesh limited participating in all, from the beginning.
              Ensuring proper Education for underprivileged and orphaned
              children, Funds for rural area clinics etc.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 my-10">
            <div className="bg-white">
              <p className="p-5 border-b text-justify">
                ...
                NS International feels that since we are at one with the world
                it is our responsibility to improve the world. The mission is to
                provide underprivileged and orphaned children a quality
                education which will give them the skills they need to provide
                for themselves and their families in the future – thereby
